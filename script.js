...
const account1 = {
  ...
  transactions: [500, 250.12, -300.46, 5000, -850.15, -110, -170, 1100],
  interest: 1.5,
  pin: 1111,
  transactionsDate: [
    '2022-10-27T14:43:31.074Z',
    '2022-10-24T11:24:19.761Z',
    '2020-11-15T10:45:23.907Z',
    '2020-01-22T12:17:46.255Z',
    '2020-02-12T15:14:06.486Z',
    '2020-03-09T11:42:26.371Z',
    '2020-05-21T07:43:59.331Z',
    '2020-06-22T15:21:20.814Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const formatTransactionDate = function (date, locale) {
  ...
  const daysPassed = getDaysBetweenTwoDays(new Date(), date);
...
const startLogoutTimer = function () {
  const logoutTimerCallback = function () {
    ...
    // For each call display remaining time
    labelTimer.textContent = `${minutes}:${seconds}`;

    // After timeline logout
    if (time === 0) {
